...
export function BorderText({ text, className = "overflow-hidden font-mono text-[clamp(3rem,15vw,10rem)] font-extrabold tracking-tighter text-6xl" }: BorderTextProps) {
    return (
        <Tailwind>
